...
namespace AuthServiceIN6BV.Persistance.Migrations
{
    ...
    [Migration("20260203221632_InitialUsers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthServiceIN6BV.Domain.Entities.Role", b =>
                {
            ...
            modelBuilder.Entity("AuthServiceIN6BV.Domain.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(16)
            ...
            modelBuilder.Entity("AuthServiceIN6BV.Domain.Entities.UserPasswordReset", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(16)
            ...
            modelBuilder.Entity("AuthServiceIN6BV.Domain.Entities.UserEmail", b =>
                {
                    b.HasOne("AuthServiceIN6BV.Domain.Entities.User", "User")
                        .WithOne("UserEmail")
                        .HasForeignKey("AuthServiceIN6BV.Domain.Entities.UserEmail", "UserId")
            ...
            modelBuilder.Entity("AuthServiceIN6BV.Domain.Entities.UserPasswordReset", b =>
                {
                    b.HasOne("AuthServiceIN6BV.Domain.Entities.User", "User")
                        ...
                        .HasForeignKey("AuthServiceIN6BV.Domain.Entities.UserPasswordReset", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
